...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { avatar: @attribute.avatar, character_id: @attribute.character_id, level: @attribute.level, name: @attribute.name }
    end
  ...
  test "should update attribute" do
    patch :update, id: @attribute, attribute: { avatar: @attribute.avatar, character_id: @attribute.character_id, level: @attribute.level, name: @attribute.name }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
